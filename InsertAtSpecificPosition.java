package DSAProblems.fourth_day;
...
class InsertAtSpecificPositionResult {
    /*
     * For your reference:
     *
...
public class InsertAtSpecificPosition {
    public static void main(String[] args) throws IOException {
        ...
        SinglyLinkedListNode llist_head = InsertAtSpecificPositionResult.insertNodeAtPosition(llist.head, data, position);
